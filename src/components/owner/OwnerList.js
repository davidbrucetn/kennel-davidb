...
const OwnerList = () => {
  ...
  console.log(`arrays ${owners} -> ${setOwners}`)
  ...
  return (
    <div className="container-cards">
      {owners.map(owner => <OwnerCard key={owner.id} name={owner.name} location={owner.location} experience={owner.experience} picture={owner.picture} />)}
    </div>
  );
};
